// ПРОШУ ПРОЩЕНИЯ. Сегодня по календарю Дедлайн отправки, физически не успел выполнить задание. Поэтому извиняюсь, задание не доработано, буду доделывать
...
func (t Training) distance() float64 {
	...
	return Action * LenStep / MInKm
}

// meanSpeed возвращает среднюю скорость бега или ходьбы.
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже
	return t.distance() / time.Duration	
}
...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return TrainingInfo.InfoMessage
}
 ...
 * Training.weight / MInKm * r.duration * MinInHours)
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier * Training.weight + (средняя_скорость_в_метрах_в_секунду**2 / w.Height) * CaloriesSpeedHeightMultiplier * Training.weight) * r.duration * MinsInHour)
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return s.LengthPool * CountPool / MInKm / r.duration
}
...
func ReadData(training CaloriesCalculator) string {
	...
	calories := w.calories + s.calories + r.calories
